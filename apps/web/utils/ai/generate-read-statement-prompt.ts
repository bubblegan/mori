...
export function generateReadStatementPrompt(categories: CategoryMap[]) {
  let keywordPrompt = "";
  ...
  let prompt =
    "Base on the uploaded credit card statement PDF, help me extract lines of expense in the following template. Note: Please list all the expenses. \n";
  ...
  prompt +=
    "{total payable amount} should be in decimal format without comma or dollar $ sign, like 2000.59 \n";
  prompt +=
